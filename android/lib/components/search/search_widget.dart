      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FFButtonWidget(
              onPressed: () async {
                FFAppState().whereLatLng = _model.placePickerValue.latLng;
                FFAppState().service = _model.dropDownValue!;
                FFAppState().whereCity = _model.placePickerValue.city;
                safeSetState(() {});
