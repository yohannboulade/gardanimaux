  ...
  Widget build(BuildContext context) {
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<ProviderRecord>(
        stream: ProviderRecord.getDocument(currentUserDocument!.isProvider!),
        builder: (context, snapshot) {
          ...
          final providerPageProviderRecord = snapshot.data!;
                  ...
                  children: [
                    StreamBuilder<List<PhotosRecord>>(
                      stream: queryPhotosRecord(
                        parent: providerPageProviderRecord.reference,
                        singleRecord: true,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        ...
                        final containerPhotosRecord =
                            containerPhotosRecordList.isNotEmpty
                                ? containerPhotosRecordList.first
                                : null;
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: Image.network(
                                containerPhotosRecord!.photoUrl,
                              ).image,
                            ),
                          ),
                          child: Align(
