...
import 'dart:ui';
import '/index.dart';
import 'new_petsitter3_widget.dart' show NewPetsitter3Widget;
...
class NewPetsitter3Model extends FlutterFlowModel<NewPetsitter3Widget> {
  ...
  // Stores action output result for [Backend Call - API (new provider)] action in Button widget.
  ApiCallResponse? providerStripe;
